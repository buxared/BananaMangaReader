...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/opt/cfs/bin',
 'BINLIBDEST': '/opt/cfs/lib/python3.10',
 ...
 'CONFIG_ARGS': "'--disable-shared' '--prefix' '/opt/cfs'",
 'CONFINCLUDEDIR': '/opt/cfs/include',
 'CONFINCLUDEPY': '/opt/cfs/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/user/Python-3.10.4/coverage.info',
 'COVERAGE_REPORT': '/home/user/Python-3.10.4/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/opt/cfs /opt/cfs/lib /opt/cfs/lib/python3.10 '
             '/opt/cfs/lib/python3.10/lib-dynload',
 'DESTLIB': '/opt/cfs/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/opt/cfs/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/cfs/include /opt/cfs/include '
                   '/opt/cfs/include/python3.10 /opt/cfs/include/python3.10',
 'INCLUDEDIR': '/opt/cfs/include',
 'INCLUDEPY': '/opt/cfs/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/opt/cfs/lib/python3.10',
 'LIBDIR': '/opt/cfs/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/cfs/lib/pkgconfig',
 'LIBPL': '/opt/cfs/lib/python3.10/config-3.10-arm-linux-gnueabihf',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/cfs/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/cfs/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-310-arm-linux-gnueabihf',
 ...
 'abs_builddir': '/home/user/Python-3.10.4',
 'abs_srcdir': '/home/user/Python-3.10.4',
 'datarootdir': '/opt/cfs/share',
 'exec_prefix': '/opt/cfs',
 'prefix': '/opt/cfs',
 'srcdir': '.'}
